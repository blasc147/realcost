    ...
    def home(self, request):
        if request.method == 'POST':
            ...
            if form.is_valid():
                ...
                bank_monthly_payment = self.payment(bank_principle, bank_apr, loan_periods)
                dealership_monthly_payment = self.payment(net_price, dealership_apr, loan_periods)
